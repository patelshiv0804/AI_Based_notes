	...
	return (
		<div className="app">
			<div className="main-content">
				<header className="app-header" style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 30px', background: 'white', borderBottom: '1px solid rgba(0,0,0,0.1)', backdropFilter: 'blur(10px)'}}>
					<div className="header-left" style={{display: 'flex', alignItems: 'center', gap: 30}}>
						<div className="logo" style={{display: 'flex', alignItems: 'center', gap: 12, color: '#667eea'}}>
							<Brain size={32} />
							<h1 style={{fontSize: 28, fontWeight: 700, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', margin: 0}}>AI Notes</h1>
						</div>
						<div className="search-container" style={{position: 'relative', display: 'flex', alignItems: 'center'}}>
							<Search className="search-icon" size={20} style={{position: 'absolute', left: 12, color: '#9ca3af', zIndex: 1}} />
							<input
								type="text"
								...
								style={{padding: '12px 40px', border: '2px solid #e5e7eb', borderRadius: 12, fontSize: 14, width: 300, transition: 'all 0.2s', background: 'rgba(255,255,255,0.9)'}}
							/>
						</div>
					</div>
					<div className="header-right" style={{display: 'flex', alignItems: 'center', gap: 24}}>
						...
						<button className="new-note-btn" onClick={createNewNote} title="New Note" style={{display: 'flex', alignItems: 'center', gap: 10, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: 'white', borderRadius: 16, border: 'none', fontWeight: 600, fontSize: 18, padding: '16px 32px', boxShadow: '0 4px 24px rgba(102,126,234,0.10)', cursor: 'pointer'}}>
							<Plus size={24} />
							New Note
						</button>
					</div>
						...
						<div className="content-area" style={{height: 'calc(100vh - 80px)', display: 'flex', flexDirection: 'row', width: '100%'}}>
							...
							{/* Always show AI panel side-by-side */}
