...
function ProtectionDialog({ note, onUpdateNote, onClose }) {
      ...
      <div className="encryption-dialog">
        <div className="dialog-header">
          <div className="dialog-title">
            <Shield size={24} />
            <h3>{note.isEncrypted ? "Remove Protection" : "Protect Note"}</h3>
          </div>
          ...
          {note.isEncrypted ? (
            <div className="decrypt-form">
              <div className="info-box">
                <Lock size={20} />
                <p>
                  This note is currently password protected. Enter the password to remove
                  protection.
                </p>
              </div>
            ...
            <div className="encrypt-form">
              <div className="info-box">
                <Shield size={20} />
                <p>
                  Protect this note with a password. You'll need to enter this
                  password to view and edit the note.
                </p>
              </div>
              <div className="form-group">
