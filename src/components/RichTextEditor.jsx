  ...
  useEffect(() => {
    ...
    if (
      ...
      editorRef.current.innerHTML = normalizeNbsp(
        sanitizeDirectionalMarks(note.content)
      );
    }
    ...
    return (
      <div className="encrypted-editor">
        <div className="encryption-overlay">
          ...
          <p>
            This note is password protected. Enter the password to view and
            edit.
          </p>
    ...
    <div className="rich-text-editor">
      <div className="editor-top-header">
        ...
        >
          ...
          >
            <path
              d="M3 21v-3.75L17.81 2.44a1.5 1.5 0 0 1 2.12 0l.63.63a1.5 1.5 0 0 1 0 2.12L5.75 20.0H3z"
              stroke="#6b7280"
              strokeWidth="1.5"
              strokeLinecap="round"
      ...
      <div className="editor-toolbar editor-toolbar--large">
        ...
        <button onClick={() => document.execCommand("justifyFull")}>
